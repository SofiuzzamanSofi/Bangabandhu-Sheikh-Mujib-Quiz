...
const ErrorPage = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 mt-20'>
            ...
            <p className='text-6xl font-extrabold text-red-700'>{error.status ? error.status : "Nothing found sir"}</p>

            <Link to={'/'}><button className='bg-emerald-900 m-10 py-4 px-6 rounded text-rose-50'>Go Home Page</button></Link>
        </div>
    );
};
